		...
		<div class="container">
			...
			<div>
				<div>
					...
					echo "</div>";
					echo form_open('user_authentication_actors/signin_actors');
					...
					?>
					<a href="<?php echo base_url() ?>index.php/user_authentication_actors/show_actors">To Sign Up Click Here</a>
					<?php echo form_close(); ?>
				</div>
			</div>
		</div>
